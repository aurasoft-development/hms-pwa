...
import { ArrowLeft, Calendar, User, Phone, Mail, Tag, Info, CheckCircle2, Share2 } from 'lucide-react';
                        ...
                        <Button
                            ...
                            onClick={() => {
                                if (selectedManagers.length > 0) {
                                    ...
                                    toast.success('Details resent to managers');
                                } else {
